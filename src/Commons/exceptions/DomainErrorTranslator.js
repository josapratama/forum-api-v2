...
DomainErrorTranslator._directories = {
  ...
  'REFRESH_AUTHENTICATION_USE_CASE.PAYLOAD_NOT_MEET_TYPE_SPECIFICATION': new InvariantError('refresh token harus string'),
  'DELETE_AUTHENTICATION_USE_CASE.NOT_CONTAIN_REFRESH_TOKEN': new InvariantError('harus mengirimkan token refresh'),
  'DELETE_AUTHENTICATION_USE_CASE.PAYLOAD_NOT_MEET_TYPE_SPECIFICATION': new InvariantError('refresh token harus string'),
